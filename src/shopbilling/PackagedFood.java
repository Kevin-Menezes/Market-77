...
public class PackagedFood extends javax.swing.JFrame {
    ...
    public PackagedFood(String UserFromLogin) {  // TAKING USERNAME FROM MAIN PAGE AND USING IT HERE FOR THE DATABASE TABLE NAME WHICH IS LINKED TO THE ACCOUNT
             
        initComponents();
        
        //---------------------------------------------- APP ICON --------------------------------------------------------------
        ImageIcon icon = new ImageIcon("E:\\SIES Practicals\\JAVA SWING\\SHOP_BILLING_PROJECT\\ShopBilling\\src\\shopbilling\\Packaged food.png");
    ...
    private void initComponents() {
        ...
        BasePanel.add(DairyStuff, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 25, 130, 50));
        ...
        PackagedFood.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        ...
        PackagedFood.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        BasePanel.add(PackagedFood, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 15, 210, 70));
        ...
        Item1Panel.add(Item1Image, new org.netbeans.lib.awtextra.AbsoluteConstraints(75, 30, 180, 200));
        ...
        Item2Panel.add(Item2Image, new org.netbeans.lib.awtextra.AbsoluteConstraints(65, 30, 218, 200));
        ...
        Item3Panel.add(Item3Image, new org.netbeans.lib.awtextra.AbsoluteConstraints(48, 32, 200, 200));
        ...
        Item4Panel.add(Item4Image, new org.netbeans.lib.awtextra.AbsoluteConstraints(75, 30, 200, 200));
        ...
        Item5Panel.add(Item5Image, new org.netbeans.lib.awtextra.AbsoluteConstraints(78, 30, 200, 200));
        ...
        Item6Panel.add(Item6Image, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 33, 171, 200));
        ...
        Item7Panel.add(Item7Image, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 34, 200, 200));
        ...
        Item8Panel.add(Item8Image, new org.netbeans.lib.awtextra.AbsoluteConstraints(82, 30, 170, 200));
        ...
        Item9Panel.add(Item9Image, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 30, 170, 200));
        ...
        Item10Panel.add(Item10Image, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 30, 170, 200));
        ...
        if(items<=Item1Availability) // CHECKING FOR AVAILABILITY (MINUS AVAILABILITY HOW MUCH THE USER CHOOSES QUANTITY)
        {
            try // JDBC CONNECTION FOR CHANGING AVAILABILITY
                {
                    ...
                    String sql = "UPDATE packaged_food SET item_availability=item_availability -'"+items+"' WHERE item_name='"+Item1Name+"'"; // UPDATING AVAILABILITY (MINUS)
            ...
            if(Selection==1 || Selection==-1) //1 means second option(NO).......-1 means third option(X)
            {
                ...
                try // JDBC CONNECTION FOR CHANGING AVAILABILITY BACK TO NORMAL
                {
                    ...
                    String sql = "UPDATE packaged_food SET item_availability=item_availability +'"+items+"' WHERE item_name='"+Item1Name+"'"; // UPDATING AVAILABILITY BACK TO NORMAL
...
// ------ WHEN THE DAILY STAPLES WINDOW IS OPEN CHANGING THE RATE, AVAILABILITY AND DISCOUNT OF ALL ITEMS ACCORDING TO THE ADMIN CHANGES IN DATABASE----------------
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
         ...
         try {
            ...
            String sql = "SELECT * FROM packaged_food"; // PUTTING ALL THE VALUES FROM ADMIN DATABASE IN VARIABLES
        ...
        if(items<=Item2Availability) // CHECKING FOR AVAILABILITY (MINUS AVAILABILITY HOW MUCH THE USER CHOOSES QUANTITY)
        {
            try // JDBC CONNECTION FOR CHANGING AVAILABILITY
                {
                    ...
                    String sql = "UPDATE packaged_food SET item_availability=item_availability -'"+items+"' WHERE item_name='"+Item2Name+"'"; // UPDATING AVAILABILITY (MINUS)
            ...
            if(Selection==1 || Selection==-1) //1 means second option(NO).......-1 means third option(X)
            {
                ...
                try // JDBC CONNECTION FOR CHANGING AVAILABILITY BACK TO NORMAL
                {
                    ...
                    String sql = "UPDATE packaged_food SET item_availability=item_availability +'"+items+"' WHERE item_name='"+Item2Name+"'"; // UPDATING AVAILABILITY BACK TO NORMAL
        ...
        if(items<=Item3Availability) // CHECKING FOR AVAILABILITY (MINUS AVAILABILITY HOW MUCH THE USER CHOOSES QUANTITY)
        {
            try // JDBC CONNECTION FOR CHANGING AVAILABILITY
                {
                    ...
                    String sql = "UPDATE packaged_food SET item_availability=item_availability -'"+items+"' WHERE item_name='"+Item3Name+"'"; // UPDATING AVAILABILITY (MINUS)
            ...
            if(Selection==1 || Selection==-1) //1 means second option(NO).......-1 means third option(X)
            {
                ...
                try // JDBC CONNECTION FOR CHANGING AVAILABILITY BACK TO NORMAL
                {
                    ...
                    String sql = "UPDATE packaged_food SET item_availability=item_availability +'"+items+"' WHERE item_name='"+Item3Name+"'"; // UPDATING AVAILABILITY BACK TO NORMAL
        ...
        if(items<=Item4Availability) // CHECKING FOR AVAILABILITY (MINUS AVAILABILITY HOW MUCH THE USER CHOOSES QUANTITY)
        {
            try // JDBC CONNECTION FOR CHANGING AVAILABILITY
                {
                    ...
                    String sql = "UPDATE packaged_food SET item_availability=item_availability -'"+items+"' WHERE item_name='"+Item4Name+"'"; // UPDATING AVAILABILITY (MINUS)
            ...
            if(Selection==1 || Selection==-1) //1 means second option(NO).......-1 means third option(X)
            {
                ...
                try // JDBC CONNECTION FOR CHANGING AVAILABILITY BACK TO NORMAL
                {
                    ...
                    String sql = "UPDATE packaged_food SET item_availability=item_availability +'"+items+"' WHERE item_name='"+Item4Name+"'"; // UPDATING AVAILABILITY BACK TO NORMAL
        ...
        if(items<=Item5Availability) // CHECKING FOR AVAILABILITY (MINUS AVAILABILITY HOW MUCH THE USER CHOOSES QUANTITY)
        {
            try // JDBC CONNECTION FOR CHANGING AVAILABILITY
                {
                    ...
                    String sql = "UPDATE packaged_food SET item_availability=item_availability -'"+items+"' WHERE item_name='"+Item5Name+"'"; // UPDATING AVAILABILITY (MINUS)
            ...
            if(Selection==1 || Selection==-1) //1 means second option(NO).......-1 means third option(X)
            {
                ...
                try // JDBC CONNECTION FOR CHANGING AVAILABILITY BACK TO NORMAL
                {
                    ...
                    String sql = "UPDATE packaged_food SET item_availability=item_availability +'"+items+"' WHERE item_name='"+Item5Name+"'"; // UPDATING AVAILABILITY BACK TO NORMAL
        ...
        if(items<=Item6Availability) // CHECKING FOR AVAILABILITY (MINUS AVAILABILITY HOW MUCH THE USER CHOOSES QUANTITY)
        {
            try // JDBC CONNECTION FOR CHANGING AVAILABILITY
                {
                    ...
                    String sql = "UPDATE packaged_food SET item_availability=item_availability -'"+items+"' WHERE item_name='"+Item6Name+"'"; // UPDATING AVAILABILITY (MINUS)
            ...
            if(Selection==1 || Selection==-1) //1 means second option(NO).......-1 means third option(X)
            {
                ...
                try // JDBC CONNECTION FOR CHANGING AVAILABILITY BACK TO NORMAL
                {
                    ...
                    String sql = "UPDATE packaged_food SET item_availability=item_availability +'"+items+"' WHERE item_name='"+Item6Name+"'"; // UPDATING AVAILABILITY BACK TO NORMAL
        ...
        if(items<=Item7Availability) // CHECKING FOR AVAILABILITY (MINUS AVAILABILITY HOW MUCH THE USER CHOOSES QUANTITY)
        {
            try // JDBC CONNECTION FOR CHANGING AVAILABILITY
                {
                    ...
                    String sql = "UPDATE packaged_food SET item_availability=item_availability -'"+items+"' WHERE item_name='"+Item7Name+"'"; // UPDATING AVAILABILITY (MINUS)
            ...
            if(Selection==1 || Selection==-1) //1 means second option(NO).......-1 means third option(X)
            {
                ...
                try // JDBC CONNECTION FOR CHANGING AVAILABILITY BACK TO NORMAL
                {
                    ...
                    String sql = "UPDATE packaged_food SET item_availability=item_availability +'"+items+"' WHERE item_name='"+Item7Name+"'"; // UPDATING AVAILABILITY BACK TO NORMAL
        ...
        if(items<=Item8Availability) // CHECKING FOR AVAILABILITY (MINUS AVAILABILITY HOW MUCH THE USER CHOOSES QUANTITY)
        {
            try // JDBC CONNECTION FOR CHANGING AVAILABILITY
                {
                    ...
                    String sql = "UPDATE packaged_food SET item_availability=item_availability -'"+items+"' WHERE item_name='"+Item8Name+"'"; // UPDATING AVAILABILITY (MINUS)
            ...
            if(Selection==1 || Selection==-1) //1 means second option(NO).......-1 means third option(X)
            {
                ...
                try // JDBC CONNECTION FOR CHANGING AVAILABILITY BACK TO NORMAL
                {
                    ...
                    String sql = "UPDATE packaged_food SET item_availability=item_availability +'"+items+"' WHERE item_name='"+Item8Name+"'"; // UPDATING AVAILABILITY BACK TO NORMAL
        ...
        if(items<=Item9Availability) // CHECKING FOR AVAILABILITY (MINUS AVAILABILITY HOW MUCH THE USER CHOOSES QUANTITY)
        {
            try // JDBC CONNECTION FOR CHANGING AVAILABILITY
                {
                    ...
                    String sql = "UPDATE packaged_food SET item_availability=item_availability -'"+items+"' WHERE item_name='"+Item9Name+"'"; // UPDATING AVAILABILITY (MINUS)
            ...
            if(Selection==1 || Selection==-1) //1 means second option(NO).......-1 means third option(X)
            {
                ...
                try // JDBC CONNECTION FOR CHANGING AVAILABILITY BACK TO NORMAL
                {
                    ...
                    String sql = "UPDATE packaged_food SET item_availability=item_availability +'"+items+"' WHERE item_name='"+Item9Name+"'"; // UPDATING AVAILABILITY BACK TO NORMAL
        ...
        if(items<=Item10Availability) // CHECKING FOR AVAILABILITY (MINUS AVAILABILITY HOW MUCH THE USER CHOOSES QUANTITY)
        {
            try // JDBC CONNECTION FOR CHANGING AVAILABILITY
                {
                    ...
                    String sql = "UPDATE packaged_food SET item_availability=item_availability -'"+items+"' WHERE item_name='"+Item10Name+"'"; // UPDATING AVAILABILITY (MINUS)
            ...
            if(Selection==1 || Selection==-1) //1 means second option(NO).......-1 means third option(X)
            {
                ...
                try // JDBC CONNECTION FOR CHANGING AVAILABILITY BACK TO NORMAL
                {
                    ...
                    String sql = "UPDATE packaged_food SET item_availability=item_availability +'"+items+"' WHERE item_name='"+Item10Name+"'"; // UPDATING AVAILABILITY BACK TO NORMAL
...
// ----------------------------------------------------- WHEN PACKAGED FOOD WINDOW IS ACTIVATED ------------------------------------------------      
